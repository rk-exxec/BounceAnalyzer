...
class Ui_Bounce(object):
    def setupUi(self, Bounce):
        ...
        self.toggleStreakBtn = QPushButton(self.dataTab)
        self.toggleStreakBtn.setObjectName(u"toggleStreakBtn")

        self.horizontalLayout_8.addWidget(self.toggleStreakBtn)
    ...
    def retranslateUi(self, Bounce):
        ...
        self.toggleStreakBtn.setText(QCoreApplication.translate("Bounce", u"Toggle Streak", None))
